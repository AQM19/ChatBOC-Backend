...
INSERT_RESPONSE = lambda chat_id, user_id, response: f"INSERT INTO chat_messages (chat_id, user_id, message, is_response) values ('{str(chat_id)}', '{str(user_id)}', '{str(response)}', True)"